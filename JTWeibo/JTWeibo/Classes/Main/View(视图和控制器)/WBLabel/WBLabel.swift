...
// TextKit 实现 label 的底层实现, url 高亮可交互
import UIKit

@objc
public protocol WBLabelDelegate: NSObjectProtocol {
    /// 选中链接文本
    ///
    /// - parameter label: label
    /// - parameter text:  选中的文本
    @objc optional func labelDidSelectedLinkText(label: WBLabel, text: String)
}

public class WBLabel: UILabel {

    public var linkTextColor = UIColor.blue
    public var selectedBackgroudColor = UIColor.lightGray
    public weak var delegate: WBLabelDelegate?
